...
daemon_control_script = '/data/opt/presto/oms_current/bin/launcher  --etc-dir=/etc/presto1'

config_directory = '/etc/presto1'

all_content_key = 'all-other-configs.filecontent1'
config_properties_key = 'config.properties1'
connectors_properties_key = 'connectors.properties1'
jvm_config_key = 'jvm.config1'
node_properties_key = 'node.properties1'

node_data_dir = '/data1/var/presto/data1'
