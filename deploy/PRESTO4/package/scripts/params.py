...
daemon_control_script = '/data/opt/presto4/oms_current/bin/launcher  --etc-dir=/etc/presto4'

config_directory = '/etc/presto4'

all_content_key = 'all-other-configs.filecontent4'
config_properties_key = 'config.properties4'
connectors_properties_key = 'connectors.properties4'
jvm_config_key = 'jvm.config4'
node_properties_key = 'node.properties4'

node_data_dir = '/data1/var/presto/data4'
