...
public class BigoIndigoUidHashMod {

    static final long K0 = 0xc3a5c85c97cb3127L;
    static final long K1 = 0xb492b66fbe98f273L;
    static final long K2 = 0x9ae16a3b2f90404fL;

    @Description("self build hive udf, indigouidhashmod")
    @ScalarFunction("indigouidhashmod")
    @SqlType(StandardTypes.BIGINT)
    public static long indigoUidHashMod(@SqlType(StandardTypes.VARCHAR) Slice salt, @SqlType(StandardTypes.BIGINT) long uid) {
        return evaluate(salt.toStringUtf8(), uid);
    }
...
//    public Integer evaluate(String s, int b){
//        return mod(hash(s), b);
//    }

    public static Integer evaluate(String salt, Long uid) {
        String obj = salt + uid;
        return mod(hash(obj), 100);
    }
