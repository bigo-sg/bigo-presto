...
public abstract class FunctionsTestUtil
{
    protected final Session session;
    private final FeaturesConfig config;
    protected FunctionAssertions functionAssertions;

    protected FunctionsTestUtil()
    {
        this(TEST_SESSION);
    }

    protected FunctionsTestUtil(Session session)
    {
        this(session, new FeaturesConfig());
    }

    protected FunctionsTestUtil(FeaturesConfig config)
    {
        this(TEST_SESSION, config);
    }

    protected FunctionsTestUtil(Session session, FeaturesConfig config)
    {
