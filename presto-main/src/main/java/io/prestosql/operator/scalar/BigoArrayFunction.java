...
public final class BigoArrayFunction
    ...
    public ScalarFunctionImplementation specialize(BoundVariables boundVariables, int arity, Metadata metadata) {
        ...
        try {
            Method method = clazz.getMethod("arrayFunction", stackTypes.toArray(new Class<?>[stackTypes.size()]));
    ...
    private static Class<?> generateArrayConstructor(List<Class<?>> stackTypes, Type elementType) {
        ...
        ClassDefinition definition = new ClassDefinition(
                a(PUBLIC, FINAL),
                makeClassName(Joiner.on("").join(stackTypeNames) + "ArrayFunction"),
                type(Object.class));
        ...
        MethodDefinition method = definition.declareMethod(a(PUBLIC, STATIC), "arrayFunction", type(Block.class), parameters.build());
        ...
        return defineClass(definition, Object.class, binder.getBindings(), new DynamicClassLoader(BigoArrayFunction.class.getClassLoader()));
    }
}
