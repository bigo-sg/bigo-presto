...
import io.prestosql.execution.AddPartitionTask;
    ...
    protected void setup(Binder binder)
    {
        ...
        httpClientBinder(binder).bindHttpClient("memoryManager", ForMemoryManager.class)
                ...
                .withConfigDefaults(config -> {
                    config.setIdleTimeout(new Duration(200, SECONDS));
        ...
        bindDataDefinitionTask(binder, executionBinder, CreateTableLike.class, CreateTableLikeTask.class);
        bindDataDefinitionTask(binder, executionBinder, LoadData.class, LoadDataTask.class);
